...
<html lang="en">
  ...
  <body class="d-flex flex-column">
	...
	<div id="main">
		<div class="row">
			<div class="col">
				<ul id="main-menu" class="nav flex-column nav-pills bg-secondary text-white">
					<li class="nav-item">
						<span class="nav-link text-white-50"><small>MENU</small></span></li>
					<li class="nav-item">
						<a href="/admin/pages" class="nav-link<?php if(resolve('/admin/pages.*')): ?> active<?php endif; ?>"><i class="fas fa-file-alt"></i> Páginas</a>
					</li>
					<li class="nav-item">
